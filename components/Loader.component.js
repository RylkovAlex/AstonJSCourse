...
export default class LoaderComponent extends AbstractComponent {
  _html = `<div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>`;
  #css = `
  .loader_wrapper {
    width: fit-content;
    margin: 0 auto;
  ...
  init() {
    ...
    this.getElement().classList.add('loader_wrapper');
    super.init();
  }
}
